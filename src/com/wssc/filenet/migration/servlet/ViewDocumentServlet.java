...
/**
 * Servlet implementation class for Servlet: ViewDocumentServlet
 * It is used to send output stream to Prizm when user clicks on Title
 */
@WebServlet("/ViewDocumentServlet")
 public class ViewDocumentServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("ViewDocumentServlet "+id);
		if(id != null)
